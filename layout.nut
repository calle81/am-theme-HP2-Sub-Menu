...
class UserConfig {
	</ label="HYPERPIE2 SUB MENU OPTIONS", help="Brought to you by Project HyperPie", order=1 /> uct1=" ";
	...
	</ label=" ", help="Brought to you by Project HyperPie", order=17 /> uct6=" ";
