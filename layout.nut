...
class UserConfig {
   ...
   </ label="Select or Disable Background Image", help="Select theme background", options="Solid, Per System,Per Title,City Lights, Pixel Skyline, Pixel Dojo, Neon, None", order=2 /> enable_bg="Solid"; 
   ...
   </ label="Select Wheel Layout", help="Select wheel type", options="List Box,Horizontal,Horizontal Animated,Vertical Wheel", order=15 /> enable_list_type="Horizontal";
...
local wheelImage = fe.add_artwork( "fanart" ,flx + bbm, bth - floor( wheelImageH / 2 ), wheelImageW, wheelImageH )
